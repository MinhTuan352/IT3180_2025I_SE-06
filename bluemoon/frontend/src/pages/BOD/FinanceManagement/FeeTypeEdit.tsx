...
export default function FeeTypeEdit() {
            ...
            try {
                ...
                if (response && response.data && response.data.data) {
                    ...
                    if (found) {
                        ...
                        navigate('/bod/finance/fee-types');
                    }
                }
            } catch (error) {
    ...
    return (
        <Box sx={{ p: 3 }}>
            <Button
                ...
                onClick={() => navigate('/bod/finance/fee-types')}
                sx={{ mb: 2 }}
            >
                Quay lại
            </Button>
            ...
            <Paper sx={{ p: 3, maxWidth: 700, margin: 'auto', borderRadius: 3 }}>
                ...
                <Box sx={{ display: 'flex', justifyContent: 'flex-end', gap: 2, mt: 4 }}>
                    <Button onClick={() => navigate('/bod/finance/fee-types')} disabled={saving}>
                        Hủy
                    </Button>
